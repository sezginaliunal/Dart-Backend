...
class UserController extends BaseController<User> {
  ...
  /// Genel bir metod: alan ve değere göre kullanıcı getirir
  Future<ApiResponse<User?>> findUserByField(String field, dynamic value) {
    return findOneByField(field, value, fromJson);
  }

  /// Genel bir metod: alan ve değere göre kullanıcı getirir
  Future<ApiResponse<Map<String, dynamic>>> insertUser(User user) {
    return insertDocument(document: user.toJson());
  }
